...
spark2-submit --class TransformJSON.StructuredStreamingKafkaSource --jars json-simple-1.1.jar TransformJSONData-1.0-SNAPSHOT.jar Transform_Data_App_KSMS_config.json
